...
import StyledProfile, { Avatar, StyledBlock, Info, Paragraph, SmallParagraph, Text, SkilsWrapper, Skill, BadgesWrapper, Badges, Name , SubName, StylingElement } from './StyledProfile';
