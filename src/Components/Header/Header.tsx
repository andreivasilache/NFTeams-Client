        ...
        <StyledHeader>
            <div className='left-panel'>
                ...
                <div className="left-panel__info">
                    ...
                    <Box sx={{ width: '150px'}} >
                        <LinearProgress variant="determinate" color='primary' value={20} classes={{barColorPrimary:classes.barColorPrimary, colorPrimary: classes.colorPrimary}} />
                    </Box>
                    <div className='left-panel__finance'>
                        <MoneyIcon />
                        <span className='left-panel__finance-value'>0.99645</span>
                    </div>
                </div>
            </div>
